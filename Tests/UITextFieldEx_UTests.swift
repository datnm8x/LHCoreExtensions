...
class UITextFieldEx_UTests: XCTestCase {
    ...
    func testExample() {
        ...
        var result = textFieldTest.shouldChangeCharactersInRange(withMaxLenght: 2, inRange: NSRange(location: 0, length: 0), replacementString: "ab")
        expect(result.0) == true
        
        result = textFieldTest.shouldChangeCharactersInRange(withMaxLenght: 2, inRange: NSRange(location: 0, length: 0), replacementString: "abc")
        expect(result.0) == false
        
        textFieldTest.text = "abc"
        
        result = textFieldTest.shouldChangeCharactersInRange(withMaxLenght: 2, inRange: NSRange(location: 1, length: 0), replacementString: "")
        expect(result.0) == false
