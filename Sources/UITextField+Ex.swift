...
public extension UITextField {
    ...
    func shouldChangeCharactersInRange(numericType: NumericType, maxValue: Float? = nil, maxFractionDigits: Int? = nil, inRange: NSRange, replacementString string: String) -> Bool {
        ...
        let result: Bool = resultString.isNumeric(type: numericType, maxFractionDigits: 1)
...
public extension String {
    func isNumeric(type: NumericType, groupSeparator: String? = nil, maxFractionDigits: UInt? = nil) -> Bool {
        ...
        if maxFractionDigits != nil && numericNumber != nil && self.contains(decimalSeparator) {
            ...
            return UInt((fractionDigits ?? "").length) <= maxFractionDigits!
        }
